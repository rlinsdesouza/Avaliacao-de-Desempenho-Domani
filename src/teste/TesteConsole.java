...
//		remover();
	...
	public void remover () {
		...
		try {
			System.out.println("removendo uma producao com avaliacao vinculada: (PROUCAO DIA 14/10/2018) - FUNCIONARIA HELENA (COD 2) ");
			Fachada.removerProducao(Fachada.listarProducoesPorDataFuncionario("2018-10-14",2).get(0));
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
		try {
			System.out.println("removendo uma producao sem avaliacao vinculada: (PROUCAO DIA 01/10/2018) - FUNCIONARIA HELENA (COD 2) ");
			List<Producao> lp = Fachada.listarProducoesPorDataFuncionario("2018-10-01",2);
			Producao p = Fachada.removerProducao(lp.get(0));
	...
	public void consultar () {
		...
		System.out.println("Notas das produ��es do funcionario Helena(id 2) entre 01/10/2018 a 15/10/2018: ");
		List<Producao> lphelena = Fachada.listarProducoesPorDataFuncionario("2018-10-01", "2018-10-15", 2);
		System.out.println(lphelena);
